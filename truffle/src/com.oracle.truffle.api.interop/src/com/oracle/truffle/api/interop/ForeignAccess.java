...
public final class ForeignAccess {
     ...
     * @param baseClass the super class of all {@link TruffleObject}s handled by this factory (if
     *            <code>null</code> then the second interface must also implement {@link Factory})
     * @param factory the factory that handles access requests to {@link Message}s known as of version
     *            0.26
     * @return new instance wrapping <code>factory</code>
     * @since 0.26
     ...
     *
     * @param factory the factory that handles access requests to {@link Message}s
     * @param languageCheck a {@link RootNode} that performs the language check on receiver objects, can
     *            be <code>null</code>, but then the factory must also implement {@link Factory}
     *            interface
     * @return new instance wrapping <code>factory</code>
     * @since 0.30
     */
     ...
     * @throws ClassCastException if the createNode has not been created by {@link Message#createNode()}
     *             method.
     ...
     * @throws ClassCastException if the createNode has not been created by {@link Message#createNode()}
     *             method.
     * @throws InteropException if any error occurred while accessing the <code>receiver</code> object
     * @since 0.24
     */
     ...
     * @throws UnknownIdentifierException if the <code>receiver</code> does not allow reading a property
     *             for the given <code>identifier</code>
     * @since 0.24
     */
     ...
     * @throws UnknownIdentifierException if the <code>receiver</code> does not allow writing a property
     *             for the given <code>identifier</code>
     ...
     * @return <code>true</code> if the property was successfully removed, <code>false</code> otherwise
     * @throws ClassCastException if the createNode has not been created by {@link Message#createNode()}
     *             method.
     * @throws UnsupportedMessageException if the <code>receiver</code> does not support the
     *             {@link Message#createNode() message represented} by <code>readNode</code>
    ...
    /**
     * Sends an {@link Message#TO_NATIVE TO_NATIVE message} to the foreign receiver object by executing
     * the <code> toNativeNode </code>.
     *
     ...
     *             unsupported type
     * @throws ArityException if the <code>arguments</code> array does not contain the right number of
     *             arguments for the foreign function
     * @throws UnsupportedMessageException if the <code>receiver</code> does not support the
    ...
    /**
     * Sends an {@link Message#IS_EXECUTABLE IS_EXECUTABLE message} to the foreign receiver object by
     * executing the <code> isExecutableNode </code>.
     *
    ...
    /**
     * Sends an {@link Message#IS_INSTANTIABLE IS_INSTANTIABLE message} to the foreign receiver object
     * by executing the <code>isInstantiableNode</code>.
     *
     ...
     * @throws UnsupportedTypeException if one of element of the <code>arguments</code> has an
     *             unsupported type
     * @throws UnknownIdentifierException if the <code>receiver</code> does not have a property for the
     *             given <code>identifier</code> that can be invoked
     * @throws ArityException if the <code>arguments</code> array does not contain the right number of
     *             arguments for the foreign function
     * @throws UnsupportedMessageException if the <code>receiver</code> does not support the
    ...
    /**
     * Sends an {@link Message#IS_NULL IS_NULL message} to the foreign receiver object by executing the
    ...
    /**
     * Sends an {@link Message#HAS_SIZE HAS_SIZE message} to the foreign receiver object by executing
     * the <code> hasSizeNode </code>.
     *
    ...
    /**
     * Sends a {@link Message#GET_SIZE GET_SIZE message} to the foreign receiver object by executing the
    ...
    /**
     * Sends an {@link Message#IS_BOXED IS_BOXED message} to the foreign receiver object by executing
    ...
    /**
     * Sends a {@link Message#KEY_INFO KEY_INFO message} to the foreign receiver object by executing the
     * <code>keyInfoNode</code>. If the object does not support the message, the presence of the key is
     * found by iteration over it's keys on a slow path and a default info is returned.
     *
    ...
    /**
     * Sends an {@link Message#HAS_KEYS HAS_KEYS message} to the foreign receiver object by executing
     * the <code>hasKeysNode</code>. If the object does not support the message, a {@link Message#KEYS}
     * message is sent to test the presence of keys.
     *
     ...
     * @param receiver foreign object to receive the message passed to {@link Message#createNode()}
     *            method
     * @return return an instance of {@link TruffleObject} that responds to {@link Message#HAS_SIZE} and
     *         {@link Message#GET_SIZE} and its 0 to {@link Message#GET_SIZE size - 1} indexes contain
     *         {@link String} names of the properties of the <code>receiver</code> object
     ...
     * {@code TruffleObject}. A Truffle language implementation accesses a {@code TruffleObject} via a
     * {@code Message}. The {@code TruffleObject} instance provides a {@link ForeignAccess} instance
     * (built via {@link #create(com.oracle.truffle.api.interop.ForeignAccess.Factory)}) that provides
     * an AST snippet for a given {@link Message}. Rather than using this generic {@code Factory},
     * consider implementing {@link StandardFactory} interface that captures the set of standard
     * messages each language should implement.
     *
     * @since 0.8 or earlier
     */
    public interface Factory {
        ...
        /**
         * Checks whether provided {@link TruffleObject} can be accessed using AST snippets produced by this
         * {@link Factory}.
         *
         ...
         * @return the AST snippet for accessing the {@code TruffleObject}, wrapped as a {@code CallTarget}.
         * @since 0.8 or earlier
         */
    ...
    /**
     * Specialized {@link Factory factory} that handles standard foreign {@link Message messages}. This
    ...
    public interface StandardFactory {
         ...
         *
         * @return call target to handle the message or <code>null</code> if this message is not supported
         * @since 0.30
         */
        ...
        /**
         * Handles request for access to a message not known in version 0.10. The parameter to the returned
         * {@link CallTarget} is going to be the object/receiver. The return value is supposed to be a
         * {@link TruffleObject} that represents an array (responds to {@link Message#HAS_SIZE} and
         * {@link Message#GET_SIZE} and its element represent {@link String} names of properties of the
         * receiver.
         *
         * @return call target to handle the message or <code>null</code> if this message is not supported
         * @since 0.30
