...
public final class SLLogicalAndNode extends SLShortCircuitNode {
    ...
    /**
     * Only if left and right value are true the result of the logical and is <code>true</code>. If the
     * second parameter is not evaluated, <code>false</code> is provided.
     */
    @Override
