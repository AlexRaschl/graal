...
public abstract class SLReadLocalVariableNode extends SLExpressionNode {
    ...
    protected long readLong(VirtualFrame frame) {
        /*
         * When the FrameSlotKind is Long, we know that only primitive long values have ever been written to
         * the local variable. So we do not need to check that the frame really contains a primitive long
         * value.
         */
