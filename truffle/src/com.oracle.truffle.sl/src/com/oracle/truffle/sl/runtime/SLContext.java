...
public final class SLContext {
    ...
    /**
     * The default default, i.e., the output for the {@link SLPrintlnBuiltin}. To allow unit testing, we
     * do not use {@link System#out} directly.
     */
    ...
    public void installBuiltin(NodeFactory<? extends SLBuiltinNode> factory) {
        /*
         * The builtin node factory is a class that is automatically generated by the Truffle DSL. The
         * signature returned by the factory reflects the signature of the @Specialization methods in the
         * builtin classes.
         */
        int argumentCount = factory.getExecutionSignature().size();
        SLExpressionNode[] argumentNodes = new SLExpressionNode[argumentCount];
        /*
         * Builtin functions are like normal functions, i.e., the arguments are passed in as an Object[]
         * array encapsulated in SLArguments. A SLReadArgumentNode extracts a parameter from this array.
         */
    ...
    /**
     * Allocate an empty object. All new objects initially have no properties. Properties are added when
     * they are first stored, i.e., the store triggers a shape change of the object.
     */
    ...
    public static boolean isSLObject(TruffleObject value) {
        /*
         * LAYOUT.getType() returns a concrete implementation class, i.e., a class that is more precise than
         * the base class DynamicObject. This makes the type check faster.
         */
