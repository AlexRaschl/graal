...
public final class Introspection {
    ...
    /**
     * Returns <code>true</code> if the given node is introspectable. If something is introspectable is
     ...
     * A node must declare at least one specialization and must be annotated with {@link Introspectable}
     * otherwise an {@link IllegalArgumentException} is thrown. If multiple specializations with the
     * same method name are declared then an undefined specialization is going to be returned. In such
     * cases disambiguate them by renaming the specialzation method name. The returned introspection
     * information is not updated when the state of the given operation node is updated. The
     * implementation of this method might be slow, do not use it in performance critical code.
     *
     ...
     * node must declare at least one specialization and must be annotated with {@link Introspectable}
     * otherwise an {@link IllegalArgumentException} is thrown. The returned introspection information
     * is not updated when the state of the given operation node is updated. The implementation of this
     * method might be slow, do not use it in performance critical code.
     *
     * @param node a introspectable DSL operation with at least one specialization
     * @see Introspection example usage
     * @since 0.22
    ...
    public static final class SpecializationInfo {
        ...
        /**
         * Returns the method name of the introspected specialization. Please note that the returned method
         * name might not be unique for a given node.
         *
         * @since 0.22
         */
        ...
        /**
         * Returns <code>true</code> if the specialization was active at the time when the introspection was
         * performed.
         *
         * @since 0.22
         */
        ...
        /**
         * Returns <code>true</code> if the specialization was excluded at the time when the introspection
         * was performed.
         *
         * @since 0.22
         */
        ...
        /**
         * Returns the cached state for a given specialization instance. The provided instance index must be
         * greater or equal <code>0</code> and smaller {@link #getInstances()}. The returned list is
         * unmodifiable and never <code>null</code>.
         *
         * @since 0.22
         */
    ...
    public interface Provider {
         ...
         * {@link Introspection} data to be returned from the {@link #getIntrospectionData()} method. The
         * format of the <code>data</code> parameters is internal, thus this method shall only be used by
         * the nodes generated by the DSL processor. A DSL user must not call this method.
         *
         * @param data introspection data in an internal format
         * @return wrapped data to be used by
         *         {@link Introspection#getSpecializations(com.oracle.truffle.api.nodes.Node)} and similar
         *         methods
         * @since 0.22
         */
