...
public interface NodeValueMap {
    ...
    /**
     * @return {@code true} if there is an {@link Value operand} associated with the {@code node} in the
     *         current block.
     */
    ...
    /**
     * Gets the {@link ValueNode} that produced a {@code value}. If the {@code value} is not associated
     * with a {@link ValueNode} {@code null} is returned.
     *
