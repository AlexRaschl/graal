...
public interface StateSplit extends NodeWithState {
    ...
    /**
     * Determines if this node has a side-effect. Such nodes cannot be safely re-executed because they
     * modify state which is visible to other threads or modify state beyond what is captured in
     * {@link FrameState} nodes.
     */
