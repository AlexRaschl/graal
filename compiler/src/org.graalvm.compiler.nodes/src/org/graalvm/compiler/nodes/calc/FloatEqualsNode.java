...
public final class FloatEqualsNode extends CompareNode implements BinaryCommutative<ValueNode> {
    ...
    public boolean isIdentityComparison() {
        ...
        /*
         * If both stamps have at most one 0.0 and it's the same 0.0 then this is an identity comparison.
         * FloatStamp isn't careful about tracking the presence of -0.0 so assume that anything that
         * includes 0.0 might include -0.0. So if either one is non-zero then it's an identity comparison.
         */
