...
public interface Virtualizable {
    ...
    /**
     * A node class can implement this method to convey information about what its effect would be if
     * some of its inputs were virtualized. All modifications must be made through the supplied tool,
     * and not directly on the node, because by the time this method is called the
