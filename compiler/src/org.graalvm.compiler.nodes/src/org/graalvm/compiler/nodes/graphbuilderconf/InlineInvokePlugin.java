...
public interface InlineInvokePlugin extends GraphBuilderPlugin {
    ...
    final class InlineInfo {
        ...
        /**
         * Denotes a call site that must not be inlined and should be implemented by a node that does not
         * speculate on the call not raising an exception.
         */
        public static final InlineInfo DO_NOT_INLINE_WITH_EXCEPTION = new InlineInfo(null, null, null);

        /**
         * Denotes a call site must not be inlined and can be implemented by a node that speculates the call
         * will not throw an exception.
         */
        public static final InlineInfo DO_NOT_INLINE_NO_EXCEPTION = new InlineInfo(null, null, null);

        /**
         * Denotes a call site must not be inlined and the execution should be transferred to interpreter in
        ...
        /**
         * Returns the original method if this is an inline of an intrinsic, or {@code null} if the call
         * site must not be inlined.
         */
        ...
        /**
         * Gets the provider of bytecode to be parsed for {@link #getMethodToInline()} if is is an intrinsic
         * for the original method (i.e., the {@code method} passed to
         * {@link InlineInvokePlugin#shouldInlineInvoke}). A {@code null} return value indicates that this
         * is not an intrinsic inlining.
         */
     ...
     * {@link InlineInfo#getMethodToInline method} is inlined. Note that it can be a different method
     * than the one specified here as the parameter, which allows method substitutions.
     * <p>
