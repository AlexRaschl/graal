...
public abstract class BinaryNode extends FloatingNode implements Canonicalizable.Binary<ValueNode> {
    ...
    /**
     * Compute an improved for this node using the passed in stamps. The stamps must be compatible with
     * the current values of {@link #x} and {@link #y}. This code is used to provide the default
