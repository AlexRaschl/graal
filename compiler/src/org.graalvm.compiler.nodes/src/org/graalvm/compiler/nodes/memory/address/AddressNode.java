...
public abstract class AddressNode extends FloatingNode implements IndirectCanonicalization {
    ...
    /**
     * Constant that is the maximum displacement from the base and index for this address. This value is
     * used to determine whether using the access as an implicit null check on the base is valid.
     *
