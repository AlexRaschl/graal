...
public interface GraphTypes {
    /**
     * Recognizes an
     * <q>enum</q> object. If the <code>enumValue</code> object represents an enum, then an object that
     * represents its class shall be returned.
     *
    ...
    /**
     * Ordinal of an enum. If the <code>obj</code> represents an enum, then return its ordinal number
    ...
    /**
     * All possible values of an enum. If the provided <code>maybeEnumClass</code> object represents an
     * enum, then compute enum value names in ordinal order and return them as a string array. Otherwise
