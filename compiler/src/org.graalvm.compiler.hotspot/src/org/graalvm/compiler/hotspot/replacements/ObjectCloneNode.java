...
public final class ObjectCloneNode extends BasicObjectCloneNode implements VirtualizableAllocation, ArrayLengthProvider {
    ...
    protected Stamp computeStamp(ValueNode object) {
        ...
        /*
         * If this call can't be intrinsified don't report a non-null stamp, otherwise the stamp would
         * change when this is lowered back to an invoke and we might lose a null check.
         */
