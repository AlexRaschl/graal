...
public interface ForeignCallsProvider extends ValueKindFactory<LIRKind> {
    ...
    /**
     * Determines if a given foreign call is side-effect free. Deoptimization cannot return execution to
     * a point before a foreign call that has a side effect.
     */
     ...
     * {@link LocationIdentity#any()} denotes that the call kills all memory locations. Returning any
     * empty array denotes that the call does not kill any memory locations.
     */
