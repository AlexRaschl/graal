...
public interface ForeignCallLinkage extends InvokeTarget {
    ...
    /**
     * Returns the maximum absolute offset of a PC relative call to this stub from any position in the
     ...
     *
     * @return {@code true} if the register allocator must save all live registers around a call to this
     *         target
     */
     ...
     * function can raise an exception, try to lock, trigger GC or do anything else that requires the VM
     * to be able to inspect the thread's execution state.
     */
