...
public @interface Snippet {
     ...
     * must use exactly the same arguments as the call that is being intrinsified. For well known
     * snippets that are used after frame state assignment, we want to relax this restriction.
     */
     ...
     * template instantiation. During snippet template creation, its value must be an array whose length
     * specifies the number of arguments (the contents of the array are ignored) bound to the parameter
