...
import micro.benchmarks.list.impl.FixedCapacitySpecifiedArrayList;

public class FixedCapacityArrayListBenchmark extends BenchmarkBase {

    // private static final int N = 1000;

    @State(Scope.Benchmark)
    public static class ThreadState {
        final FixedCapacitySpecifiedArrayList<Integer> list = new FixedCapacitySpecifiedArrayList<>(BMConstants.N);
