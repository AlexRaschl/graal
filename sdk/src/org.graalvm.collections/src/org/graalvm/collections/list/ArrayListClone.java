...
public class ArrayListClone<E> extends SpecifiedArrayList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
     ...
     */
    public ArrayListClone(Collection<? extends E> c) {
    ...
    public Object clone() {
        try {
            ArrayListClone<?> v = (ArrayListClone<?>) super.clone();
     ...
     * to <tt>null</tt>. (This is useful in determining the length of the list <i>only</i> if the caller
     ...
     * exists). Returns <tt>true</tt> if this list contained the specified element (or equivalently, if
    ...
    /**
     * Constructs an IndexOutOfBoundsException detail message. Of the many possible refactorings of the
     * error handling code, this "outlining" performs best with both server and client VMs.
     */
    ...
    private class Itr implements Iterator<E> {
        ...
        public E next() {
            ...
            Object[] elementData = ArrayListClone.this.elementData;
        ...
        public void remove() {
            ...
            try {
                ArrayListClone.this.remove(lastRet);
                cursor = lastRet;
                lastRet = -1;
        ...
        public void forEachRemaining(Consumer<? super E> consumer) {
            ...
            final int size = ArrayListClone.this.size;
            int i = cursor;
            if (i >= size) {
                return;
            }
            final Object[] elementData = ArrayListClone.this.elementData;
            if (i >= elementData.length) {
                throw new ConcurrentModificationException();
            }
    ...
    private class ListItr extends Itr implements ListIterator<E> {
        ...
        public void set(E e) {
            ...
            try {
                ArrayListClone.this.set(lastRet, e);
            } catch (IndexOutOfBoundsException ex) {
                throw new ConcurrentModificationException();
            }
        }
    ...
    private class SubList extends AbstractList<E> implements RandomAccess {
        ...
        SubList(AbstractList<E> parent,
            ...
            this.modCount = ArrayListClone.this.modCount;
        }
        ...
        public E set(int index, E e) {
            rangeCheck(index);
            checkForComodification();
            E oldValue = ArrayListClone.this.elementData(offset + index);
            ArrayListClone.this.elementData[offset + index] = e;
            return oldValue;
        }
        ...
        public E get(int index) {
            rangeCheck(index);
            checkForComodification();
            return ArrayListClone.this.elementData(offset + index);
        }
        ...
        protected void removeRange(int fromIndex, int toIndex) {
            checkForComodification();
            try {
                throw new Exception("Remove Rang no available");
            } catch (Exception e) {
                e.printStackTrace();
            }
...
// this.modCount = parent.modCount;
        ...
        public ListIterator<E> listIterator(final int index) {
            ...
            return new ListIterator<E>() {
                int cursor = index;
                int lastRet = -1;
                int expectedModCount = ArrayListClone.this.modCount;
                ...
                public void remove() {
                    ...
                    try {
                        ...
                        cursor = lastRet;
                        lastRet = -1;
                        expectedModCount = ArrayListClone.this.modCount;
                    } catch (IndexOutOfBoundsException ex) {
                        throw new ConcurrentModificationException();
                    }
                }
                ...
                public void set(E e) {
                    ...
                    try {
                        ArrayListClone.this.set(offset + lastRet, e);
                    } catch (IndexOutOfBoundsException ex) {
                        throw new ConcurrentModificationException();
                    }
                }
                ...
                final void checkForComodification() {
                    if (expectedModCount != ArrayListClone.this.modCount)
                        throw new ConcurrentModificationException();
                }
            };
        }
        ...
        private void checkForComodification() {
            if (ArrayListClone.this.modCount != this.modCount)
                throw new ConcurrentModificationException();
        }
    ...
    @Override
    public Spliterator<E> spliterator() {
        return new ArrayListCloneSpliterator<>(this, 0, -1, 0);
    }

    /** Index-based split-by-two, lazily initialized Spliterator */
    static final class ArrayListCloneSpliterator<E> implements Spliterator<E> {
        ...
        private final ArrayListClone<E> list;
        private int index; // current index, modified on advance/split
        private int fence; // -1 until used; then one past last index
        private int expectedModCount; // initialized when fence set

        /** Create new spliterator covering the given range */
        ArrayListCloneSpliterator(ArrayListClone<E> list, int origin, int fence,
        ...
        public ArrayListCloneSpliterator<E> trySplit() {
            ...
            return (lo >= mid) ? null : // divide range in half unless too small
                            new ArrayListCloneSpliterator<E>(list, lo, index = mid,
                                            expectedModCount);
        }
