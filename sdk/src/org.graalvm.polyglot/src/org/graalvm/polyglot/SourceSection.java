...
public final class SourceSection {
     ...
     * <code>1</code> for out of bounds or {@link #isAvailable() unavailable} source sections. Note that
     * calling this method causes the {@link Source#getCharacters() code} of the {@link #getSource()
     ...
     * {@link #isAvailable() unavailable} source sections. Note that calling this method does not cause
     * the {@link Source#getCharacters() code} of the {@link #getSource() source} to be loaded. The
     ...
     * {@link #isAvailable() unavailable} source sections. Note that calling this method does not cause
     * the {@link Source#getCharacters() code} of the {@link #getSource() source} to be loaded. The
     * returned length might be out of bounds of the source code if assertions (-ea) are not enabled.
     *
     ...
     * Returns <code>0</code> for {@link #isAvailable() unavailable} source sections. Note that calling
     * this method does not cause the {@link Source#getCharacters() code} of the {@link #getSource()
     * source} to be loaded. The returned index might be out of bounds of the source code if assertions
     * (-ea) are not enabled.
     *
    ...
    /**
     * Returns the source code fragment described by this section. Returns an empty string for out of
     * bounds or {@link #isAvailable() unavailable} source sections. Note that calling this method
     * causes the {@link Source#getCharacters() code} of the {@link #getSource() source} to be loaded if
